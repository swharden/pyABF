...
# NOTE: ABFFIO.DLL generated these using the C# program in /dev/firstValues
FIRSTVALUES = {}
...
FIRSTVALUES['190619B_0003'] = [-65.91796, -0.00946]
FIRSTVALUES['19122043'] = [-0.00031, 0.06104, -43.47229, 0.97656]
...
FIRSTVALUES['File_axon_3'] = [-0.15500, -55.00000]
...
FIRSTVALUES['H19_29_150_11_21_01_0011'] = [-67.95655, -0.48828]
...
def test_valuesMatch_firstValue(abfPath):
    ...
    firstValues = [None]*abf.channelCount
    for i in abf.channelList:
        abf.setSweep(0, i)
        firstValues[i] = abf.sweepY[0]

    if not abf.abfID in FIRSTVALUES.keys():
        raise NotImplementedError(
            "test_values.py is missing: %s %s" % (abf.abfID, firstValues))

    # test that values are accurate to 5 decimal places
    np.testing.assert_almost_equal(
        actual=firstValues,
        desired=FIRSTVALUES[abf.abfID],
        decimal=5)
