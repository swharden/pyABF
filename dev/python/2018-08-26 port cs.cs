...
char fFileVersionNumber = FileReadSignedChars("fFileVersionNumber", -1, 4); //4b;
...
uchar uFileGUID = FileReadUnsignedChars("uFileGUID", -1, 16); //16B;
uchar uCreatorVersion = FileReadUnsignedChars("uCreatorVersion", -1, 4); //4B;
...
char sUnused = FileReadChars("sUnused", -1, 3); //3c;
...
float fCellID = FileReadFloats("fCellID", -1, 3); //3f;
