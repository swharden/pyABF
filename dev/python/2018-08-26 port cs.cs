...
fFileVersionNumber = FileReadSignedChars("fFileVersionNumber", -1, 4); //4b;
...
uFileGUID = FileReadUnsignedChars("uFileGUID", -1, 16); //16B;
uCreatorVersion = FileReadUnsignedChars("uCreatorVersion", -1, 4); //4B;
