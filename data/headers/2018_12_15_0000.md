...
* epochPoints = `[0, 31, 1031, 1531, 2031, 3031, 4031, 2000]`
* epochValues = `[0.0, 0.0, 100.0, 100.0, 100.0, 100.0, -100.0, 0.0]`
...
DAC waveform is controlled by epoch table:
                Ch1 EPOCH      A      B
                     Type   Step   Step
         First Level (mV)    100    100
         Delta Level (mV)    -20    -10
 First Duration (samples)    500    500
