...
* fileGUID = `8F92BF12-A392-4FCF-9C94-47C4F08F22D2`
...
* sweepChannel = `0`
* sweepCount = `9`
* sweepDerivative = `array (1d) with values like: -122.07031, 122.07031, -244.14062, ..., 0.00000, -366.21094, -366.21094`
...
* nFileType = `1`
* nSimultaneousScan = `1`
* sFileGUID = `8F92BF12-A392-4FCF-9C94-47C4F08F22D2`
* sFileSignature = `ABF2`
* uCreatorNameIndex = `1`
...
* lLength = `[20000, 20000, 20000, 20000, 20000, 20000, 20000, 20000, 20000]`
* lStart = `[0, 400000, 800000, 1200000, 1600000, 2000000, 2400000, 2800000, 3200000]`
...
* indexedStrings = `['', 'clampex', 'C:\\Axon\\Params\\step cclamp.pro', '_Ipatch', 'mV', 'Cmd 0', 'pA', 'Cmd 1', 'mV', 'Cmd 2', 'mV', 'Cmd 3', 'mV', '']`
