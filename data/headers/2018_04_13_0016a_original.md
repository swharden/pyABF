...
* fileUUID = `B97CB13B-6B24-70E4-7856-DB4B4CAF757C`
* holdingCommand = `[-70.0, 0.0, 0.0, 0.0]`
* md5 = `B97CB13B6B2470E47856DB4B4CAF757C`
* protocol = `ONRec_Hv1`
...
* lLength = `[95000, 95000, 95000, ..., 95000, 95000, 95000]`
* lStart = `[430000, 907500, 1385000, ..., 23827500, 24305000, 24782500]`
...
* indexedStrings = `['', 'Clampex', 'C:\\Users\\RL_lab\\Documents\\Molecular Devices\\pCLAMP\\Params\\Emerson\\ONRec_Hv1.pro', '1 Hv1 dNdC N264R pH7/7 ONRec 150mV', 'Ipatch', 'pA', 'IpatcC', 'pA', '_Cmd 0', 'mV', '_Cmd 1', 'V', '_Cmd 2', 'V', '_Cmd 3', 'V', '']`
