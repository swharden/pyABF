...
* abfDateTimeString = `2018-04-13T15:00:47.629000`
...
* dacUnits = `['mV', 'V']`
* data = `[[-115.9668 -125.1221 -128.1738 ... -146.4844 -149.5361 -137.3291] [-15.2588 0. 6.1035 ... -61.0352 -67.1387 -45.7764]]`
* dataByteStart = `5632`
* dataPointByteSize = `2`
...
* epochPoints = `[0, 742, 1992, 6992, 7492, 12492, 16242, 47500]`
* epochValues = `[-70.0, -70.0, -70.0, 150.0, -70.0, 150.0, -70.0, -70.0]`
...
* sweepUnitsX = `sec`
* sweepUnitsY = `pA`
* sweepX = `[0. 0. 0. ... 0.19 0.19 0.19]`
* sweepY = `[-115.9668 -125.1221 -128.1738 ... -115.9668 -115.9668 -119.0185]`
* tagComments = `[]`
* tagSweeps = `[]`
* tagTimesMin = `[]`
* tagTimesSec = `[]`
