...
* DACSection = `[3, 256, 8]`
* DataSection = `[36, 2, 368640]`
* DeltaSection = `[1477, 12, 1]`
* EpochPerDACSection = `[0, 0, 0]`
* EpochSection = `[0, 0, 0]`
* MathSection = `[0, 0, 0]`
* ProtocolSection = `[1, 512, 1]`
* ScopeSection = `[34, 833, 1]`
* StatsRegionSection = `[7, 128, 1]`
* StatsSection = `[0, 0, 0]`
* StringsSection = `[33, 249, 30]`
* SynchArraySection = `[0, 0, 0]`
* TagSection = `[1476, 64, 1]`
...
* indexedStrings = `[, Clampex, C:\mPC_Raw Data_Local\Protocols\Current_Clamp_gap free.pro, ..., mV, IN 7, ]`
...
* uModifierName = ``
* uProtocolPath = `C:\mPC_Raw Data_Local\Protocols\Current_Clamp_gap free.pro`
