...
* abfDateTimeString = `2018-07-11T14:09:04.490000`
* abfFileComment = ``
...
* dacNames = `['Cmd 0']`
* dacUnits = `['pA']`
* data = `[[-66.6656 -66.7267 -66.6351 ... -65.1398 -65.1703 -65.2008]]`
* dataByteStart = `6656`
* dataPointByteSize = `2`
...
* epochPoints = `[0, 468, 6468, 16468, 26468, 30000]`
* epochValues = `[0.0, 0.0, -100.0, 0.0, 0.0, 0.0]`
* fileGUID = `{32F669AA-A9B4-45AC-B3E2-DB31D8819494}`
...
* sweepUnitsX = `sec`
* sweepUnitsY = `mV`
* sweepX = `[0. 0.0001 0.0001 ... 1.4999 1.4999 1.5]`
* sweepY = `[-66.6656 -66.7267 -66.6351 ... -66.4978 -66.5588 -66.5436]`
* tagComments = `[]`
* tagSweeps = `[]`
* tagTimesMin = `[]`
* tagTimesSec = `[]`
...
* nFileType = `1`
* nSimultaneousScan = `1`
* sFileGUID = `{32F669AA-A9B4-45AC-B3E2-DB31D8819494}`
* uCreatorNameIndex = `1`
