...
* indexedStrings = `[, Clampex, C:\mPC_Raw Data_Local\Protocols\Trigem_Current_Clamp_Current injection_Neg.pro, ..., IN 7, -200, -150, -100, -50, 0, 25, 50, 100, 150, 200, 250, 300, 350, 400, 500, 600,, ]`
* lADCChannelName = `['Potential', 'I_Com']`
* lADCUnits = `['mV', 'pA']`
* lDACChannelName = `['current', 'OUT 1', 'Cmd 2', 'Cmd 3', 'Cmd 4', 'Cmd 5', 'Cmd 6', 'Cmd 7']`
* lDACChannelUnits = `['pA', 'V', 'mV', 'mV', 'mV', 'mV', 'mV', 'mV']`
* lDACFilePath = `['', '', '', '', '', '', '', '']`
* lFileComment = ``
* nLeakSubtractADC = `['', '', '', '', '', '', '', '']`
* uCreatorName = `Clampex`
* uModifierName = ``
* uProtocolPath = `C:\mPC_Raw Data_Local\Protocols\Trigem_Current_Clamp_Current injection_Neg.pro`
