...
* abfDateTime = `2016-09-21 14:43:46.434000`
...
* dacNames = `['Cmd 0']`
* dacUnits = `['mV']`
* data = `array (2d) with values like: -7.20215, -6.71387, -5.73730, ..., -27.95410, -27.46582, -26.00097`
* dataByteStart = `5632`
* dataLengthMin = `16.1`
* dataLengthSec = `966.0`
* dataPointByteSize = `2`
* dataPointCount = `19280000`
* dataPointsPerMs = `20`
* dataRate = `20000`
...
* sweepChannel = `0`
* sweepCount = `482`
* sweepDerivative = `array (1d) with values like: 9765.62500, 19531.25000, 31738.28125, ..., 4882.81250, 19531.25000, 19531.25000`
* sweepEpochs = `Sweep epoch waveform: Step -70.00 [0:625], Step -80.00 [625:4625], Step -70.00 [4625:40000]`
...
* sweepLengthSec = `2.0`
* sweepList = `[0, 1, 2, ..., 479, 480, 481]`
* sweepNumber = `0`
* sweepPointCount = `40000`
* sweepTimesMin = `array (1d) with values like: 0.00000, 0.03333, 0.06667, ..., 15.96667, 16.00000, 16.03333`
* sweepTimesSec = `array (1d) with values like: 0.00000, 2.00000, 4.00000, ..., 958.00000, 960.00000, 962.00000`
* sweepUnitsC = `mV`
* sweepUnitsX = `sec`
* sweepUnitsY = `pA`
...
* nFileType = `1`
* nSimultaneousScan = `1`
* sFileGUID = `1A6008BD-FC47-4D06-948D-AC67988CCF00`
* sFileSignature = `ABF2`
* uCreatorNameIndex = `1`
* uCreatorVersion = `[2, 0, 3, 10]`
* uFileCRC = `0`
* uFileGUID = `[189, 8, 96, 26, 71, 252, 6, 77, 148, 141, 172, 103, 152, 140, 207, 0]`
* uFileInfoSize = `512`
* uFileStartDate = `20160921`
* uFileStartTimeMS = `53026434`
...
* bEnabledDuringPN = `[0]`
* fADCDisplayAmplification = `[10.41650676727295]`
...
* lStart = `[0, 160000, 320000, ..., 76640000, 76800000, 76960000]`
