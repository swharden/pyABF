...
* abfDateTimeString = `2018-03-13T14:45:56.159`
* abfFileComment = ``
...
* dataByteStart = `5632`
* dataLengthMin = `0.016666666666666666`
* dataLengthSec = `1.0`
* dataPointByteSize = `2`
...
* sweepChannel = `0`
* sweepCount = `1`
* sweepDerivative = `array (1d) with values like: 91.55273, -213.62305, 61.03516, ..., -122.07031, 91.55273, 91.55273`
...
* nFileType = `1`
* nSimultaneousScan = `1`
* sFileGUID = `40392588-482D-4FB4-AEE0-820FF5221D88`
* sFileSignature = `ABF2`
* uCreatorNameIndex = `1`
...
* indexedStrings = `[, Clampex, D:\Axon DATA\EXPT test\PacemakerTempTest.pro, ..., Cmd 7, mV, ]`
